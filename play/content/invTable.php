...
<div class='box'>
  <div class='boxBody'>
    <table id='inventory' class='table'>
      <thead>
      <tr>" .
  "<th class='th_inventory'>Name" .
  "</th>" .
  "<th class='th_inventory'>Quantity ⓘ" .
  "<span class='tooltip'>How many of each fruit you currently have.</span>" .
  "</th>" .
  "<th class='th_inventory'>Selling price ⓘ" .
  "<span class='tooltip'>How much you're selling each fruit for. Click to change it.</span>" .
  "</th>" .
  "<th class='th_inventory' onClick=printDevDataHTML()>Restock price ⓘ" .
  ...
  "</th>" .
  "<th class='th_inventory' onClick=printDevData1()>Factors ⓘ" .
  ...
  "</th>" .
  "<th class='th_inventory' onClick=printDevData2()>Restock ⓘ" .
